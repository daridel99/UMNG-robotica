    ...
    for n in range(6,9):
        for i in range(0,4):
            for j in range(0,4):                
                ...
                globals()["arr"+ str(9) +"_" + str(i) + str(j)].set(matri[0][i][j]) #globals()

def llenado2 (matri):
    for n in range(1,5):
        for i in range(0,4):
            for j in range(0,4):                
                globals()["arr"+ str(n) +"_" + str(i) + str(j)].set(matri[1][n-1][i][j]) #globals()
                globals()["arr"+ str(5) +"_" + str(i) + str(j)].set(matri[0][i][j]) #globals()
